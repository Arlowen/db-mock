...
CREATE TABLE IF NOT EXISTS hosts (
    ...
    data_root_writable boolean NOT NULL DEFAULT false,
    port_probe_available boolean NOT NULL DEFAULT false,
    available_port integer NOT NULL DEFAULT 0 CHECK (available_port = 0 OR available_port BETWEEN 1 AND 65535),
