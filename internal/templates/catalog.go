...
func Builtins() []Definition {
	...
	return []Definition{
		...
		{Slug: "oceanbase", Name: "OceanBase CE", NameZH: "OceanBase 社区版", Description: "OceanBase CE mini single-host mode", Category: "distributed-sql", Tier: experimental, Icon: "OB", Version: "4.3.5-lts", Image: "oceanbase/oceanbase-ce:4.3.5-lts", Architectures: []string{"amd64"}, MinCPU: 4, MinMemory: 8 * GiB, MinDisk: 30 * GiB, Port: 2881, Username: "root", Database: "test", Scheme: "mysql", JDBCScheme: "mysql", DataTarget: "/root/ob", Environment: map[string]string{"MODE": "mini", "OB_ROOT_PASSWORD": "${DB_PASSWORD}"}, Healthcheck: []string{"CMD-SHELL", "obclient -h127.0.0.1 -P2881 -uroot -p$${DB_PASSWORD} -e 'select 1'"}},
