...
export interface Registry { id: string; name: string; url: string; username?: string; hasPassword: boolean; hasCaCertificate: boolean; status: string; createdAt: string; updatedAt: string; lastTestedAt?: string }
...
export interface Alert { id: string; severity: string; type: string; resourceType: string; resourceId: string; title: string; message: string; details?: Record<string, unknown>; status: string; createdAt: string; acknowledgedAt?: string; resolvedAt?: string }
export interface Webhook { id: string; name: string; url: string; hasSecret: boolean; events: string[]; enabled: boolean; createdAt: string; updatedAt: string }
...
export interface ImageArtifact { id: string; name: string; filename: string; sizeBytes: number; sha256: string; format: string; imageRefs: string[]; architectures: string[]; status: string; createdAt: string; lastUsedAt?: string }
