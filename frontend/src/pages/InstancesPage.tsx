...
import { imageArtifactMatchesTemplate, imageArtifactSupportsAnyArchitecture, imageRegistryHost, registryMatchesTemplate, templateImageReferences } from '../lib/image-source'
...
export function InstancesPage() {
  ...
  useEffect(() => {
    ...
    setDrawer(true)
  }, [addRequiredHost, canOperate, createRequested, form, hasOnlineHost, loading, requestedImageAvailable, requestedImageHostAvailable, requestedImageID, requestedTemplateAvailable, requestedTemplateID, setParams])
