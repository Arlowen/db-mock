    ...
    {showList && (compactLayout
      ? <Card className="task-mobile-list-card" title={!showFilters ? t('tasks') : undefined} extra={!showFilters ? listActions : undefined}>
          {visibleItems.length
            ...
            : <div className="task-mobile-empty"><EmptyState compact action={hasFilters ? clearFilters : undefined} actionLabel={t('clearFilters')} actionType="default" description={hasFilters ? t('tasksFilteredEmptyDescription') : t('tasksEmptyDescription')} /></div>}
